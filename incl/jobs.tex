...
\subsection*{1996-00 Structural engineer, John Brown \textsc{in}} % (fold)
\label{sub:c6}

Responsible for structural deliverables in detailed design projects (offshore and onshore), viz., design reports + drawings.

% subsection c6 (end)

\subsection*{1995-96 Junior engineer, Gammon \textsc{in}} % (fold)
\label{sub:c7}

Responsible for structural deliverables in public infrastructure projects (e.g. bridges and foundations), viz., design reports + drawings.
